function t = FitData(temps,rating,target_vas,t,s)
...
set(t.hFig,'Position',[s.screenRes.width*0.05 s.screenRes.height*0.3 s.screenRes.width*0.25 s.screenRes.height*0.3]);
xplot = 40:.1:48;
